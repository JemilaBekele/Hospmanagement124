...
const UpdateMedicalDataDoc = () => {
    ...
    useEffect(() => {
        const fetchMedicalData = async () => {
            try {
                ...
                if (responseData && responseData.data && responseData.data.medicalDatadoc && responseData.data.medicalDatadoc.length > 0) {
                    // Find the medical data by ID
                    const medicalData = responseData.data.medicalDatadoc.find(data => data._id === medicalDatadocID);
                    if (medicalData) {
                        // Update state with fetched medical data
                        setMedicalDataInfo(medicalData);
                    } else {
        ...
        fetchMedicalData();
    }, [patientId, medicalDatadocID, authToken]);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.patch(`/api/v1/doc/medicine/${patientId}/fix/${medicalDatadocID}`, medicalDataInfo, {
                headers: {
                    Authorization: `Bearer ${authToken}`,
            ...
            <form onSubmit={handleSubmit} className="flex lg:w-[1180px] flex-col flex-wrap gap-4">
                <div className="flex gap-8">
                    <div className="lg:w-1/2 ">
                        ...
                        <Textarea type="text"  name="AreaDiscomfort" value={medicalDataInfo.AreaDiscomfort} onChange={handleChange} className="w-full resize-none" // Add the resize-none class to prevent resizing of the TextArea
                             rows={6} />
                    </div>
                ...
                <div className="lg:w-1/5">
                        ...
                        <Select id="Frequencypian"  name="Frequencypian" value={medicalDataInfo.Frequencypian} onChange={handleChange} >
                    ...
                    <div className="lg:w-1/5">
                        ...
                        <Select id="Daypain"  name="Daypain" value={medicalDataInfo.Daypain} onChange={handleChange} >
                ...
                <div className="flex gap-8">          
                    <div className="lg:w-1/2">
                        ...
                        <Textarea type="text" name="Releatedtreatment" value={medicalDataInfo.Releatedtreatment} onChange={handleChange} className="w-full resize-none" rows={6}  />
                    </div>
                </div>
                <div className="flex gap-8">
               <div className="lg:w-1/2">
                   ...
                   <Textarea type="text" name="increasedecreasepain" value={medicalDataInfo.increasedecreasepain} onChange={handleChange} className="w-full resize-none" rows={6}  />
               </div>
           </div>
           <div className="flex gap-8">
                <div className="lg:w-1/2 h-30">
                        ...
                        <Textarea type="text" name="symptoms" value={medicalDataInfo.symptoms}  onChange={handleChange} className="w-full resize-none" rows={6} />
                    </div>
           </div>
           <h2 className="mb-4 text-3l font-medium">Labratory Test Request Form</h2>
                <div className="flex gap-8">
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <Select id="Clinicalchemistry"  name="Clinicalchemistry" value={medicalDataInfo.Clinicalchemistry} onChange={handleChange} >
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <Select id="Urinalysis" name="Urinalysis" value={medicalDataInfo.Urinalysis} onChange={handleChange} >
                            <option>Color</option>
                ...
                <div className="flex gap-8">
                    <div className="lg:w-1/3">
                        ...
                        <Select id="serology" name="serology" value={medicalDataInfo.serology} onChange={handleChange} >
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <Select id="bacteriology" name="bacteriology" value={medicalDataInfo.bacteriology} onChange={handleChange} >
                            <option>KOH</option>
                ...
                <div className="flex gap-8">
                    <div className="lg:w-1/3">
                        ...
                        <Select id="hematology" name="hematology" value={medicalDataInfo.hematology} onChange={handleChange} >
                            <option>CBC</option>
                            <option>ESR</option>
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <Select id="coagulation" name="coagulation"  value={medicalDataInfo.coagulation} onChange={handleChange} >
                            <option>PT</option>
                            <option>PTT</option>
                            <option>INR</option>                        
                     </Select>
                ...
                <div className="flex gap-8">
                    <div className="lg:w-1/3">
                        ...
                        <Select id="stoolexamination"  name="stoolexamination"  value={medicalDataInfo.stoolexamination} onChange={handleChange} >
                            <option>Color</option>
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <Select id="electrolytepanel" name="electrolytepanel"   value={medicalDataInfo.electrolytepanel} onChange={handleChange} >
                ...
                <div className="flex gap-8">
                    <div className="lg:w-1/3">
                        ...
                        <Select id="hormonalassay" name="hormonalassay" value={medicalDataInfo.hormonalassay} onChange={handleChange} >
...
export default UpdateMedicalDataDoc;
